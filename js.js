   ...
   // JavaScript to control the animation of quotes
...
function showNextQuote() {
    ...
    }, 1000); // Add a small delay for smoother fade-in
}
...
// Start the animation
setInterval(showNextQuote, 8000); // Change the duration (in milliseconds) as needed
